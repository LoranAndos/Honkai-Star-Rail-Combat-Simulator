...
def startSimulator(cycleLimit=5, s1: Character = None, s2: Character = None, s3: Character = None, s4: Character = None,
    ...
    enemySPD = [158.4, 130]  # make sure that the number of entries in this list is the same as "numEnemies"
    ...
    if all([a is None for a in [s1, s2, s3, s4]]):
        ...
        slot2 = YaoGuang(1, Role.SUP1, 1, eidolon=1, targetPrio=Priority.DEFAULT)
...
if __name__ == "__main__":
    ...
    enemyModule = EnemyModule(2, [95, 95], [EnemyType.BOSS, EnemyType.ELITE],
                              [158.4, 130], [160, 100], atkRatio, [Element.PHYSICAL], [1]) # 2 enemyModule

    #enemyModule = EnemyModule(5, [95, 95, 95, 95, 95],
    #                          [EnemyType.ADD, EnemyType.ELITE, EnemyType.BOSS, EnemyType.ADD, EnemyType.ADD],
    #                          [110, 130, 158.4, 110, 110], [20, 100, 160, 20, 20], atkRatio, [Element.PHYSICAL], [1]) # 5 enemyModule

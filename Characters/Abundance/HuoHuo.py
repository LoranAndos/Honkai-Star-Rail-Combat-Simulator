...
class HuoHuo(Character):
    ...
    def useSkl(self, enemyID=-1):
        ...
        hl.append(Healing("HuoHuoSkillHealingScaling",[E5BigHealScale,0],self.scaling,Role.ALL,self.role,Targeting.BLAST))
        hl.append(Healing("HuoHuoSkillHealingFlat",[0,0],self.scaling,Role.ALL,self.role,Targeting.BLAST))
        return bl, dbl, al, dl, tl, hl

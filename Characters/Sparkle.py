...
class SparkleOld(Character):
    ...
    def allyTurn(self, turn: Turn, result: Result):
        ...
        if turn.spChange <= -1:
            ...
            bl.append(Buff("SparkleVUL", StatTypes.VULN, e5VUL * 3, Role.ALL, [AtkType.ALL], 2, 3, Role.SELF, TickDown.END))
        return bl, dbl, al, dl, tl, hl
    ...
    def handleSpecialStart(self, specialRes: Special):
        ...
        if self.startSP:
            ...
            bl.append(Buff("SparkleTechERR", StatTypes.ERR_T, 20, self.role, [AtkType.ALL], 1, 1, Role.SELF, TickDown.START))

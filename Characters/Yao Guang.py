...
[self.element],[e3MulBig, e3MulSmall], [10, 5], 30, self.scaling, 1, "YaoGuangBasic"))
    ...
    def useUlt(self, enemyID=-1):
        ...
        tl.append(Turn(self.name, self.role, self.bestEnemy(enemyID), Targeting.NA, [AtkType.ULT],
                       [self.element], [0, 0], [0, 0], 0, self.scaling, 0, "YaoGuangAHAExtraTurn"))
        return bl, dbl, al, dl, tl, hl
    ...
    def useElaSkill(self, enemyID=-1):
        ...
        tl.append(Turn(self.name, self.role, self.bestEnemy(enemyID), Targeting.AOE, [AtkType.ELAPUNCH],
                       [self.element], [e5MulBig*E6ELASkillIncrease, 0], [20, 0], 5, Scaling.ELA, 1, "YaoGuangELASkillAOE"))
        tl.append(Turn(self.name, self.role, self.bestEnemy(enemyID), Targeting.SINGLE, [AtkType.ELAPUNCH],
                       [self.element], [e5MulSmall*5*E6ELASkillIncrease, 0], [5*5, 0], 5, Scaling.ELA, 0, "YaoGuangELASkillSINGLE"))
